...
namespace T9OldTelephone.ViewModels
{
    public class MainViewModel : BaseViewModel
    {
        ...
        public MainViewModel()
        {
            ...
            _readyWords.Add("Hekim");
            _readyWords.Add("Muellim");
            _readyWords.Add("Sagird");
            _readyWords.Add("Ev");
            _readyWords.Add("Evli");
            _readyWords.Add("Kendli");
            _readyWords.Add("Bakili");
            _readyWords.Add("Masin");
            _readyWords.Add("Tank");
            _readyWords.Add("Meyve");
            _readyWords.Add("Terevez");
            _readyWords.Add("Banan");
            _readyWords.Add("Kesnis");
            _readyWords.Add("Cahil");
            _readyWords.Add("Savadli");
            _readyWords.Add("Rahimov");
            _readyWords.Add("Cavadli");
            _readyWords.Add("Elsever");
            _readyWords.Add("Elgiz");
            _readyWords.Add("Fariz");
            _readyWords.Add("Sebuhi");
            _readyWords.Add("Halal");
            _readyWords.Add("Haram");
        ...
        private void AdviceOnSelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            if (T9Keyboard.Advice.SelectedIndex >= 1) { T9Keyboard.UpArrow.IsEnabled = true; }

            else { T9Keyboard.UpArrow.IsEnabled = false; }

            if (T9Keyboard.Advice.Items.Count > 0) { T9Keyboard.RightArrow.IsEnabled = true; }
        ...
        private void ButtonsClick_AddCharacter(object sender, RoutedEventArgs e)
        {
            lock (_obj)
            {
                ...
                {
                    foreach (var word in _willBeAdded) { _readyWords.Add(word); }
                ...
                else if (button.Name == "One")
                {
                    if (_buttonName != "One")
                    {
                        ...
                        if (!_saveText)
                        {
                            if (!_deleteCharacterState) { Remove1(); }
                    ...
                    else
                    {
                        ...
                        if (_clickCount == 1) { T9Keyboard.MainRichTextBox.AppendText(" "); }
                ...
                else if (button.Name == "Two")
                {
                    ...
                    else
                    {
                        ...
                        if (_clickCount == 1) { T9Keyboard.MainRichTextBox.AppendText("A"); }

                        else if (_clickCount == 2) { T9Keyboard.MainRichTextBox.AppendText("B"); }

                        else if (_clickCount == 3) { T9Keyboard.MainRichTextBox.AppendText("C"); }
                ...
                else if (button.Name == "Three")
                {
                    ...
                    else
                    {
                        ...
                        if (_clickCount == 1) { T9Keyboard.MainRichTextBox.AppendText("D"); }

                        else if (_clickCount == 2) { T9Keyboard.MainRichTextBox.AppendText("E"); }

                        else if (_clickCount == 3) { T9Keyboard.MainRichTextBox.AppendText("F"); }
                ...
                else if (button.Name == "Four")
                {
                    ...
                    else
                    {
                        ...
                        if (_clickCount == 1) { T9Keyboard.MainRichTextBox.AppendText("G"); }

                        else if (_clickCount == 2) { T9Keyboard.MainRichTextBox.AppendText("H"); }

                        else if (_clickCount == 3) { T9Keyboard.MainRichTextBox.AppendText("I"); }
                ...
                else if (button.Name == "Five")
                {
                    ...
                    else
                    {
                        ...
                        if (_clickCount == 1) { T9Keyboard.MainRichTextBox.AppendText("J"); }

                        else if (_clickCount == 2) { T9Keyboard.MainRichTextBox.AppendText("K"); }

                        else if (_clickCount == 3) { T9Keyboard.MainRichTextBox.AppendText("L"); }
                ...
                else if (button.Name == "Six")
                {
                    ...
                    else
                    {
                        ...
                        if (_clickCount == 1) { T9Keyboard.MainRichTextBox.AppendText("M"); }

                        else if (_clickCount == 2) { T9Keyboard.MainRichTextBox.AppendText("N"); }

                        else if (_clickCount == 3) { T9Keyboard.MainRichTextBox.AppendText("O"); }
                ...
                else if (button.Name == "Seven")
                {
                    ...
                    else
                    {
                        ...
                        if (_clickCount == 1) { T9Keyboard.MainRichTextBox.AppendText("P"); }

                        else if (_clickCount == 2) { T9Keyboard.MainRichTextBox.AppendText("Q"); }

                        else if (_clickCount == 3) { T9Keyboard.MainRichTextBox.AppendText("R"); }

                        else if (_clickCount == 4) { T9Keyboard.MainRichTextBox.AppendText("S"); }
                ...
                else if (button.Name == "Eight")
                {
                    ...
                    else
                    {
                        ...
                        if (_clickCount == 1) { T9Keyboard.MainRichTextBox.AppendText("T"); }

                        else if (_clickCount == 2) { T9Keyboard.MainRichTextBox.AppendText("U"); }

                        else if (_clickCount == 3) { T9Keyboard.MainRichTextBox.AppendText("V"); }
                ...
                else if (button.Name == "Nine")
                {
                    ...
                    else
                    {
                        ...
                        if (_clickCount == 1) { T9Keyboard.MainRichTextBox.AppendText("W"); }

                        else if (_clickCount == 2) { T9Keyboard.MainRichTextBox.AppendText("X"); }

                        else if (_clickCount == 3) { T9Keyboard.MainRichTextBox.AppendText("Y"); }

                        else if (_clickCount == 4) { T9Keyboard.MainRichTextBox.AppendText("Z"); }
